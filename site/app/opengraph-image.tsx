...
export const alt = "OmniPulse: Register once. Find every copy.";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <span style={{ color: "#C0401E", fontSize: 14, fontFamily: "monospace", letterSpacing: "0.14em", textTransform: "uppercase" }}>
            Private beta
          </span>
        </div>
      </div>
